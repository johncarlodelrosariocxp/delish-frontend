...
const Bill = ({ orderId }) => {
  ...
  const handleIncrement = (itemId) => {
    if (!currentOrder || orderPlaced) return;
  ...
  // If order is placed, show only the invoice
  if (orderPlaced && showInvoice && orderInfo) {
    return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mr-3">
                    <button
                      ...
                      disabled={
                        item.quantity <= 1 || item.isRedeemed || orderPlaced
                      }
                    >
                      -
                    </button>
                    ...
                    <button
                      ...
                      className="w-6 h-6 flex items-center justify-center bg-gray-200 rounded-full text-gray-600 hover:bg-gray-300 text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                      disabled={item.isRedeemed || orderPlaced}
                    >
                      +
                    </button>
                  </div>
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          {!hasRedeemedItem ? (
            <button
              ...
              disabled={
                isProcessing || combinedCart.length === 0 || orderPlaced
              }
