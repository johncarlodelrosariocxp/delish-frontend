...
// --- Custom Icon Components (Replacements for react-icons/fa) ---
...
const IconCashRegister = (props) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M24 88C10.7 88 0 98.7 0 112v88c0 13.3 10.7 24 24 24H552c13.3 0 24-10.7 24-24V112c0-13.3-10.7-24-24-24H24zM80 480c-17.7 0-32-14.3-32-32s14.3-32 32-32H496c17.7 0 32 14.3 32 32s-14.3 32-32 32H80zM552 256H24c-13.3 0-24 10.7-24 24V416c0 13.3 10.7 24 24 24H552c13.3 0 24-10.7 24-24V280c0-13.3-10.7-24-24-24z" />
  </svg>
);
...
const Invoice = ({ orderInfo, setShowInvoice }) => {
  ...
  const connectBluetooth = async () => {
    ...
    try {
      ...
      // IMPORTANT FIX: Use acceptAllDevices: true to ensure the device is discoverable
      // Then use optionalServices to access characteristics once connected.
      ...
      // Step 2: Search for the writable characteristic across common services
