  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20">
      <div className="p-4">
        ...
        {(success || error) && (
          <div
            className={`mb-4 p-3 rounded-lg ${success ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
          >
            {success || error}
          </div>
        )}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
            ...
            {inventoryValue && (
              <StatCard
                ...
                value={formatCurrency(inventoryValue.totalInventoryValue)}
                icon={FaBox}
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 mb-4">
          ...
          {filters.startDate && filters.endDate && (
            <p className="text-xs text-gray-500 mt-3">
              Showing: {new Date(filters.startDate).toLocaleDateString()} -{" "}
                ...
                {loading && !expenses.length ? (
                  ...
                  filteredExpenses.map((expense) => (
                    <tr key={expense._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        {expense.usedQuantity || 0} {expense.unit}
                      </td>
                      <td className="px-4 py-3 text-right font-medium">
                        {expense.remainingQuantity} {expense.unit}
                      </td>
                      <td className="px-4 py-3 text-right">
